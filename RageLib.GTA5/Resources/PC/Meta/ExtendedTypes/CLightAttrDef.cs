...
{
	public class CLightAttrDef : MetaStructureWrapper<PC.Meta.CLightAttrDef>
	{
		...
		public CLightAttrDef(MetaName metaName) : base(metaName)
		{
			this.MetaStructure = new PC.Meta.CLightAttrDef();
		}

		public void Parse(MetaFile meta, PC.Meta.CLightAttrDef CLightAttrDef)
		{
			this.Meta = meta;
