...
{
	public class rage__fwGrassInstanceListDef__InstanceData : MetaStructureWrapper<PC.Meta.rage__fwGrassInstanceListDef__InstanceData>
	{
		...
		public rage__fwGrassInstanceListDef__InstanceData(MetaName metaName) : base(metaName)
		{
			this.MetaStructure = new PC.Meta.rage__fwGrassInstanceListDef__InstanceData();
		}

		public void Parse(MetaFile meta, PC.Meta.rage__fwGrassInstanceListDef__InstanceData rage__fwGrassInstanceListDef__InstanceData)
		{
			this.Meta = meta;
