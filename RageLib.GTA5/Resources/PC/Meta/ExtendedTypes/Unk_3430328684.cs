...
{
	public class Unk_3430328684 : MetaStructureWrapper<PC.Meta.Unk_3430328684>
	{
		...
		public Unk_3430328684(MetaName metaName) : base(metaName)
		{
			this.MetaStructure = new PC.Meta.Unk_3430328684();
		}

		public void Parse(MetaFile meta, PC.Meta.Unk_3430328684 Unk_3430328684)
		{
			this.Meta = meta;
