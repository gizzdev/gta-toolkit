...
{
	public class CExtensionDefProcObject : MetaStructureWrapper<PC.Meta.CExtensionDefProcObject>
	{
		...
		public CExtensionDefProcObject(MetaName metaName) : base(metaName)
		{
			this.MetaStructure = new PC.Meta.CExtensionDefProcObject();
		}

		public void Parse(MetaFile meta, PC.Meta.CExtensionDefProcObject CExtensionDefProcObject)
		{
			this.Meta = meta;
