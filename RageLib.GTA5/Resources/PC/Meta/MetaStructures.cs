...
*/
        ...
        public static StructureInfo[] GetStructureChildInfo(MetaName name)
        {
            ...
            switch (name)
            {
                case MetaName.CMapTypes:
                    {
                        structureInfos.Add(MetaInfo.GetStructureInfo(MetaName.CBaseArchetypeDef));
                        structureInfos.Add(MetaInfo.GetStructureInfo(MetaName.CMloArchetypeDef));
                        structureInfos.Add(MetaInfo.GetStructureInfo(MetaName.CTimeArchetypeDef));
                        structureInfos.Add(MetaInfo.GetStructureInfo(MetaName.CMloRoomDef));
                        structureInfos.Add(MetaInfo.GetStructureInfo(MetaName.CMloPortalDef));
                        structureInfos.Add(MetaInfo.GetStructureInfo(MetaName.CMloEntitySet));
                        structureInfos.Add(MetaInfo.GetStructureInfo(MetaName.CCompositeEntityType));
                        break;
                    }
                case MetaName.CBaseArchetypeDef:
                    {
