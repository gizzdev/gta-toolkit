        ...
        public static EnumInfo GetEnumInfo(MetaName name)
        {
            switch (name)
            {
                case (MetaName)(1264241711):
                    return new EnumInfo(1264241711, 1856311430, 1342237904, 0, new ResourceSimpleArray<EnumEntryInfo>() {
                ...
                case (MetaName)(648413703):
                    return new EnumInfo(648413703, -2094609585, 1342238064, 0, new ResourceSimpleArray<EnumEntryInfo>() {
                ...
                case (MetaName)(884254308):
                    return new EnumInfo(884254308, -822882922, 1342181184, 0, new ResourceSimpleArray<EnumEntryInfo>() {
                        new EnumEntryInfo(476847607, -1),
                        new EnumEntryInfo(1159394596, 0),
                        new EnumEntryInfo(696691459, 1),
                        new EnumEntryInfo(-1376494346, 2),
                        new EnumEntryInfo(-587380438, 3),
                        new EnumEntryInfo(-1039972140, 4),
                        new EnumEntryInfo(-1501671006, 5),
                        new EnumEntryInfo(-1994460719, 6),
                        new EnumEntryInfo(1520752005, 7),
                        new EnumEntryInfo(-534955506, 8),
                        new EnumEntryInfo(1051671594, 9),
                        new EnumEntryInfo(-663691720, 10),
                        new EnumEntryInfo(-1918678170, 11),
                        new EnumEntryInfo(920969818, 12)
                    });

                case (MetaName)(-81990185):
                    return new EnumInfo(-81990185, 1551913633, 1342181376, 0, new ResourceSimpleArray<EnumEntryInfo>() {
                        new EnumEntryInfo(-537200028, 0),
                        new EnumEntryInfo(-559728358, 1),
                        new EnumEntryInfo(-899122173, 2)
                    });

                case (MetaName)(-1460418243):
                    return new EnumInfo(-1460418243, 1309372691, 1342181504, 0, new ResourceSimpleArray<EnumEntryInfo>() {
                        new EnumEntryInfo(-1905511652, 0),
                        new EnumEntryInfo(1125276126, 1),
                        new EnumEntryInfo(119829315, 2),
                        new EnumEntryInfo(2032023579, 3),
                        new EnumEntryInfo(100074042, 4),
                        new EnumEntryInfo(-601328428, 5),
                        new EnumEntryInfo(935290624, 6),
                        new EnumEntryInfo(1131235937, 7),
                        new EnumEntryInfo(-1516212290, 8),
                        new EnumEntryInfo(1100801960, 9),
                        new EnumEntryInfo(1776231225, 10),
                        new EnumEntryInfo(604819740, 11),
                        new EnumEntryInfo(-1936340362, 12),
                        new EnumEntryInfo(665640573, 13)
                    });

                case (MetaName)(700327466):
                    return new EnumInfo(700327466, -1480371201, 1342271976, 0, new ResourceSimpleArray<EnumEntryInfo>() {
                ...
                case (MetaName)(-721371006):
                    return new EnumInfo(-721371006, 671739257, 1342273656, 0, new ResourceSimpleArray<EnumEntryInfo>() {
                        new EnumEntryInfo(1849703770, 0),
                        new EnumEntryInfo(-123924556, 1),
                        new EnumEntryInfo(549935372, 2)
                    });

                case (MetaName)(-685159878):
                    return new EnumInfo(-685159878, -968891497, 1342273704, 0, new ResourceSimpleArray<EnumEntryInfo>() {
                        new EnumEntryInfo(528166787, 0),
                        new EnumEntryInfo(7865678, 1),
                        new EnumEntryInfo(-570849632, 2)
                    });

                case (MetaName)(-323193842):
                    return new EnumInfo(-323193842, -1278838554, 1342273680, 0, new ResourceSimpleArray<EnumEntryInfo>() {
                        new EnumEntryInfo(1129153779, 0),
                        new EnumEntryInfo(-22332836, 1),
                        new EnumEntryInfo(177164187, 2)
                    });

                case (MetaName)(941086046):
                    return new EnumInfo(941086046, 1112851290, 1342267244, 0, new ResourceSimpleArray<EnumEntryInfo>() {
                        new EnumEntryInfo(-1015392978, 0),
                        new EnumEntryInfo(-2082043326, 1),
                        new EnumEntryInfo(-272167638, 2),
                        new EnumEntryInfo(1425672334, 3),
                        new EnumEntryInfo(957720931, 4),
                        new EnumEntryInfo(-499771882, 5),
                        new EnumEntryInfo(-1460345287, 6),
                        new EnumEntryInfo(1876554076, 7),
                        new EnumEntryInfo(698543797, 8),
                        new EnumEntryInfo(1544199634, 9),
                        new EnumEntryInfo(-1569353993, 10),
                        new EnumEntryInfo(-261701476, 11),
                        new EnumEntryInfo(-1240157367, 12),
                        new EnumEntryInfo(-383961916, 13),
                        new EnumEntryInfo(-577318274, 14),
                        new EnumEntryInfo(-938941166, 15)
                    });
        ...
        public static StructureInfo GetStructureInfo(MetaName name)
        {
            switch (name)
            {
                case MetaName.rage__fwInstancedMapData:
                    return new StructureInfo(-246803010, 1836780118, 768, 0, 1342237824, 48, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                ...
                case MetaName.CLODLight:
                    return new StructureInfo(-2018753224, -1969778068, 768, 0, 1342237024, 136, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                ...
                case MetaName.CDistantLODLight:
                    return new StructureInfo(2033467892, -1474058877, 768, 0, 1342237632, 48, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, -489959468),
                ...
                case MetaName.CBlockDesc:
                    return new StructureInfo(-1222611382, 2015795449, 768, 0, 1342237728, 72, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                ...
                case MetaName.CMapData:
                    return new StructureInfo(-749125722, -846865625, 1024, 0, 1342235920, 512, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                ...
                case MetaName.CEntityDef:
                    return new StructureInfo(-833612669, 1825799514, 1024, 0, 1342236736, 128, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                ...
                case MetaName.rage__fwGrassInstanceListDef:
                    return new StructureInfo(2085051229, 941808164, 1024, 0, 1342302528, 96, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                ...
                case MetaName.VECTOR3:
                    return new StructureInfo(-489959468, -1543570224, 512, 0, 1342303104, 12, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                ...
                case (MetaName)(975711773):
                    return new StructureInfo(975711773, 1831736438, 256, 0, 1342304128, 16, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                ...
                case (MetaName)(-1553183059):
                    return new StructureInfo(-1553183059, 1172796107, 1024, 0, 1342304320, 64, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                ...
                case MetaName.CTimeCycleModifier:
                    return new StructureInfo(1733268304, -1611546519, 1024, 0, 1342304512, 64, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-421429484, 8, StructureEntryDataType.Hash, 0, 0, 0),
                ...
                case MetaName.CCarGen:
                    return new StructureInfo(1860713439, -1949729035, 1024, 0, 1342304704, 80, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                ...
                case (MetaName)(-1436020670):
                    return new StructureInfo(-1436020670, 1792487819, 768, 0, 1342179520, 40, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-1696521889, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, 94549140),
                        new StructureEntryInfo(-392164023, 8, StructureEntryDataType.Array, 0, 1, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, -2124583421),
                        new StructureEntryInfo(162345210, 24, StructureEntryDataType.Array, 0, 3, 0)
                    });

                case (MetaName)(94549140):
                    return new StructureInfo(94549140, 2029738350, 768, 0, 1342179712, 56, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-1076478661, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Float, 0, 0, 0),
                        new StructureEntryInfo(942761829, 4, StructureEntryDataType.ArrayOfBytes, 0, 1, 5),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, 254518642),
                        new StructureEntryInfo(-206031734, 24, StructureEntryDataType.Array, 0, 3, 0),
                        new StructureEntryInfo(-55384384, 40, StructureEntryDataType.IntFlags1, 0, 3, -81990185),
                        new StructureEntryInfo(1066841901, 44, StructureEntryDataType.UnsignedInt, 0, 0, 0),
                        new StructureEntryInfo(1741842546, 48, StructureEntryDataType.UnsignedShort, 0, 0, 0),
                        new StructureEntryInfo(-1563743268, 50, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-477825044, 51, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-1400341871, 52, StructureEntryDataType.UnsignedByte, 0, 0, 0)
                    });

                case MetaName.CAnchorProps:
                    return new StructureInfo(-2124583421, 403574180, 768, 0, 1342179968, 24, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-2007566758, 0, StructureEntryDataType.Array, 0, 0, 0),
                        new StructureEntryInfo(1880738441, 16, StructureEntryDataType.IntEnum, 0, 0, -1460418243)
                    });

                case (MetaName)(376833625):
                    return new StructureInfo(376833625, -264096135, 768, 0, 1342180096, 112, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(1235281004, 0, StructureEntryDataType.Boolean, 0, 0, 0),
                        new StructureEntryInfo(-208500112, 1, StructureEntryDataType.Boolean, 0, 0, 0),
                        new StructureEntryInfo(911147899, 2, StructureEntryDataType.Boolean, 0, 0, 0),
                        new StructureEntryInfo(315291935, 3, StructureEntryDataType.Boolean, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-1298406872, 4, StructureEntryDataType.ArrayOfBytes, 0, 4, 12),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, -756472076),
                        new StructureEntryInfo(-498557873, 16, StructureEntryDataType.Array, 0, 6, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, 253191135),
                        new StructureEntryInfo(2131007641, 32, StructureEntryDataType.Array, 0, 8, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, 1866571721),
                        new StructureEntryInfo(592652859, 48, StructureEntryDataType.Array, 0, 10, 0),
                        new StructureEntryInfo(-2054115880, 64, StructureEntryDataType.Structure, 0, 0, -1436020670),
                        new StructureEntryInfo(-1957269854, 104, StructureEntryDataType.Hash, 0, 0, 0)
                    });

                case (MetaName)(-756472076):
                    return new StructureInfo(-756472076, 2024084511, 768, 0, 1342180416, 24, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-923450485, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, 1535046754),
                        new StructureEntryInfo(1756136273, 8, StructureEntryDataType.Array, 0, 1, 0)
                    });

                case (MetaName)(253191135):
                    return new StructureInfo(253191135, -1174682297, 512, 0, 1342180544, 48, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-421429484, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(173599222, 4, StructureEntryDataType.ArrayOfBytes, 0, 1, 12),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-1303513025, 16, StructureEntryDataType.ArrayOfBytes, 0, 3, 12),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-696861098, 28, StructureEntryDataType.ArrayOfBytes, 0, 5, 6),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(2095974912, 34, StructureEntryDataType.ArrayOfBytes, 0, 7, 6),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(672172037, 40, StructureEntryDataType.ArrayOfBytes, 0, 9, 6)
                    });

                case MetaName.CComponentInfo:
                    return new StructureInfo(1866571721, -601120046, 512, 0, 1342180800, 48, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(802196719, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(-61833944, 4, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Float, 0, 0, 0),
                        new StructureEntryInfo(128864925, 8, StructureEntryDataType.ArrayOfBytes, 0, 2, 5),
                        new StructureEntryInfo(1741842546, 28, StructureEntryDataType.UnsignedInt, 0, 0, 0),
                        new StructureEntryInfo(-2122648363, 32, StructureEntryDataType.IntFlags2, 0, 32, 0),
                        new StructureEntryInfo(1912839368, 36, StructureEntryDataType.IntFlags2, 0, 32, 0),
                        new StructureEntryInfo(1613922652, 40, StructureEntryDataType.ShortFlags, 0, 16, 884254308),
                        new StructureEntryInfo(2114993291, 42, StructureEntryDataType.UnsignedShort, 0, 0, 0),
                        new StructureEntryInfo(-785426531, 44, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-98621505, 45, StructureEntryDataType.UnsignedByte, 0, 0, 0)
                    });

                case (MetaName)(1036962405):
                    return new StructureInfo(1036962405, -22249502, 0, 0, 1342182080, 3, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(1785432003, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(914976023, 1, StructureEntryDataType.UnsignedByte, 0, 0, 0)
                    });

                case (MetaName)(-2057986829):
                    return new StructureInfo(-2057986829, 508935687, 0, 0, 1342182208, 24, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-1466719391, 0, StructureEntryDataType.Boolean, 0, 0, 0)
                    });

                case (MetaName)(1535046754):
                    return new StructureInfo(1535046754, 124073662, 768, 0, 1342182336, 48, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-1362107837, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-1488773190, 1, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, 1036962405),
                        new StructureEntryInfo(1251090986, 8, StructureEntryDataType.Array, 0, 2, 0),
                        new StructureEntryInfo(-1830384205, 24, StructureEntryDataType.Structure, 0, 0, -2057986829)
                    });

                case (MetaName)(254518642):
                    return new StructureInfo(254518642, -1527671159, 512, 0, 1342182912, 12, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-2122648363, 0, StructureEntryDataType.IntFlags2, 0, 32, 0),
                        new StructureEntryInfo(1912839368, 4, StructureEntryDataType.IntFlags2, 0, 32, 0),
                        new StructureEntryInfo(1785432003, 8, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(1938349561, 9, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-475445110, 10, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(914976023, 11, StructureEntryDataType.UnsignedByte, 0, 0, 0)
                    });

                case MetaName.CScenarioPointContainer:
                    return new StructureInfo(-1914028693, -1805312399, 768, 0, 1342273544, 48, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, -994904520),
                        new StructureEntryInfo(-1278225305, 0, StructureEntryDataType.Array, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, -191917806),
                        new StructureEntryInfo(1170781136, 16, StructureEntryDataType.Array, 0, 2, 0)
                    });

                case (MetaName)(-271226537):
                    return new StructureInfo(-271226537, 88255871, 768, 0, 1342273096, 88, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, -954284041),
                        new StructureEntryInfo(804169170, 0, StructureEntryDataType.Array, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, -39557736),
                        new StructureEntryInfo(1456031062, 16, StructureEntryDataType.Array, 0, 2, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, 871314709),
                        new StructureEntryInfo(-1040059500, 32, StructureEntryDataType.Array, 0, 4, 0)
                    });

                case MetaName.rage__spdGrid2D:
                    return new StructureInfo(-1695816913, 894636096, 768, 0, 1342273192, 64, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(860552138, 12, StructureEntryDataType.SignedInt, 0, 0, 0),
                        new StructureEntryInfo(-470368359, 16, StructureEntryDataType.SignedInt, 0, 0, 0),
                        new StructureEntryInfo(496029782, 20, StructureEntryDataType.SignedInt, 0, 0, 0),
                        new StructureEntryInfo(-920319498, 24, StructureEntryDataType.SignedInt, 0, 0, 0),
                        new StructureEntryInfo(-1604057537, 44, StructureEntryDataType.Float, 0, 0, 0),
                        new StructureEntryInfo(-603292277, 48, StructureEntryDataType.Float, 0, 0, 0)
                    });

                case MetaName.CScenarioPointLookUps:
                    return new StructureInfo(-1275345429, -1625605709, 768, 0, 1342272432, 96, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(-1237496025, 0, StructureEntryDataType.Array, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(-1274101079, 16, StructureEntryDataType.Array, 0, 2, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(-467056755, 32, StructureEntryDataType.Array, 0, 4, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(-1788254679, 48, StructureEntryDataType.Array, 0, 6, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(-1888402044, 64, StructureEntryDataType.Array, 0, 8, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(1767860162, 80, StructureEntryDataType.Array, 0, 10, 0)
                    });

                case MetaName.CScenarioPointRegion:
                    return new StructureInfo(1492970064, -793615475, 768, 0, 1342272800, 376, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(1292187579, 0, StructureEntryDataType.SignedInt, 0, 0, 0),
                        new StructureEntryInfo(702683191, 8, StructureEntryDataType.Structure, 0, 0, -1914028693),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, -81233496),
                        new StructureEntryInfo(697469539, 72, StructureEntryDataType.Array, 0, 2, 0),
                        new StructureEntryInfo(-598921919, 96, StructureEntryDataType.Structure, 0, 0, -271226537),
                        new StructureEntryInfo(-1241812021, 184, StructureEntryDataType.Structure, 0, 0, -1695816913),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedShort, 0, 0, 0),
                        new StructureEntryInfo(-450243069, 248, StructureEntryDataType.Array, 0, 6, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, 750308016),
                        new StructureEntryInfo(-706978902, 264, StructureEntryDataType.Array, 0, 8, 0),
                        new StructureEntryInfo(1097626284, 280, StructureEntryDataType.Structure, 0, 0, -1275345429)
                    });

                case MetaName.CScenarioPoint:
                    return new StructureInfo(-191917806, 402442150, 1024, 0, 1342272224, 64, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-1042729714, 21, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-933320008, 22, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(1975994103, 23, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(1229525587, 24, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-1320356336, 25, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(717991212, 26, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(591476992, 27, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-1606928773, 28, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(1998996693, 29, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-1998778821, 30, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-2114714623, 32, StructureEntryDataType.UnsignedShort, 0, 0, 0),
                        new StructureEntryInfo(1264718594, 36, StructureEntryDataType.IntFlags2, 0, 32, 700327466),
                        new StructureEntryInfo(4685037, 48, StructureEntryDataType.Float_XYZW, 0, 0, 0)
                    });

                case MetaName.CScenarioEntityOverride:
                    return new StructureInfo(-81233496, 1271200492, 1024, 0, 1342273288, 80, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(642078041, 0, StructureEntryDataType.Float_XYZ, 0, 0, 0),
                        new StructureEntryInfo(1374199246, 16, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, -994904520),
                        new StructureEntryInfo(-328448962, 24, StructureEntryDataType.Array, 0, 2, 0),
                        new StructureEntryInfo(538733109, 64, StructureEntryDataType.Boolean, 0, 0, 0),
                        new StructureEntryInfo(1035513142, 65, StructureEntryDataType.Boolean, 0, 0, 0)
                    });

                case MetaName.CExtensionDefSpawnPoint:
                    return new StructureInfo(-994904520, -1217626575, 1024, 0, 1342258848, 96, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-421429484, 8, StructureEntryDataType.Hash, 0, 0, 0),
                ...
                case MetaName.CScenarioChainingNode:
                    return new StructureInfo(-954284041, 1811784424, 1024, 0, 1342273384, 32, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(210930065, 0, StructureEntryDataType.Float_XYZ, 0, 0, 0),
                        new StructureEntryInfo(-1692573525, 16, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(191322199, 20, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(407126079, 24, StructureEntryDataType.Boolean, 0, 0, 0),
                        new StructureEntryInfo(1308720135, 25, StructureEntryDataType.Boolean, 0, 0, 0)
                    });

                case MetaName.CScenarioChainingEdge:
                    return new StructureInfo(-39557736, 2004985940, 256, 0, 1342273464, 8, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-1058169050, 0, StructureEntryDataType.UnsignedShort, 0, 0, 0),
                        new StructureEntryInfo(-1443161257, 2, StructureEntryDataType.UnsignedShort, 0, 0, 0),
                        new StructureEntryInfo(1705836299, 4, StructureEntryDataType.ByteEnum, 0, 0, -685159878),
                        new StructureEntryInfo(859022269, 5, StructureEntryDataType.ByteEnum, 0, 0, -323193842),
                        new StructureEntryInfo(1419316113, 6, StructureEntryDataType.ByteEnum, 0, 0, 941086046)
                    });

                case MetaName.CScenarioChain:
                    return new StructureInfo(871314709, -1543056930, 768, 0, 1342273608, 40, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(1156691834, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedShort, 0, 0, 0),
                        new StructureEntryInfo(934700563, 8, StructureEntryDataType.Array, 0, 1, 0)
                    });

                case MetaName.rage__spdSphere:
                    return new StructureInfo(1062159465, 1189037266, 1024, 0, 1342267372, 16, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-205221119, 0, StructureEntryDataType.Float_XYZW, 0, 0, 0)
                    });

                case MetaName.CScenarioPointCluster:
                    return new StructureInfo(750308016, -672486877, 1024, 0, 1342259136, 80, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(702683191, 0, StructureEntryDataType.Structure, 0, 0, -1914028693),
                        new StructureEntryInfo(352461053, 48, StructureEntryDataType.Structure, 0, 0, 1062159465),
                        new StructureEntryInfo(1095875445, 64, StructureEntryDataType.Float, 0, 0, 0),
                        new StructureEntryInfo(-1165552228, 68, StructureEntryDataType.Boolean, 0, 0, 0)
                    });

                case MetaName.CStreamingRequestRecord:
                    return new StructureInfo(135915278, -469379442, 768, 0, 1342209488, 40, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, 999226379),
                        new StructureEntryInfo(419044527, 0, StructureEntryDataType.Array, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, 1358189812),
                        new StructureEntryInfo(-46561397, 16, StructureEntryDataType.Array, 0, 2, 0),
                        new StructureEntryInfo(-1961574708, 32, StructureEntryDataType.Boolean, 0, 0, 0)
                    });

                case MetaName.CStreamingRequestFrame:
                    return new StructureInfo(999226379, 1112444512, 1024, 0, 1342209116, 112, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(327274266, 0, StructureEntryDataType.Array, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(-922645965, 16, StructureEntryDataType.Array, 0, 2, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(896120921, 32, StructureEntryDataType.Array, 0, 4, 0),
                        new StructureEntryInfo(357008256, 48, StructureEntryDataType.Float_XYZ, 0, 0, 0),
                        new StructureEntryInfo(210316193, 64, StructureEntryDataType.Float_XYZ, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(1762439591, 80, StructureEntryDataType.Array, 0, 8, 0),
                        new StructureEntryInfo(1264718594, 96, StructureEntryDataType.UnsignedInt, 0, 0, 0)
                    });

                case (MetaName)(1358189812):
                    return new StructureInfo(1358189812, -584766690, 768, 0, 1342209648, 16, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(-1551848142, 0, StructureEntryDataType.Array, 0, 0, 0)
                    });
/*
                case MetaName.CStreamingRequestFrame:
                    return new StructureInfo(999226379, -622029831, 1024, 0, 1342209080, 96, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(327274266, 0, StructureEntryDataType.Array, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(-922645965, 16, StructureEntryDataType.Array, 0, 2, 0),
                        new StructureEntryInfo(357008256, 32, StructureEntryDataType.Float_XYZ, 0, 0, 0),
                        new StructureEntryInfo(210316193, 48, StructureEntryDataType.Float_XYZ, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(1762439591, 64, StructureEntryDataType.Array, 0, 6, 0),
                        new StructureEntryInfo(1264718594, 80, StructureEntryDataType.UnsignedInt, 0, 0, 0)
                    });
*/
                ...
                case MetaName.CCreatureMetaData:
                    return new StructureInfo(2042092773, -2113313724, 768, 0, 1342184848, 56, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, -413846757),
                        new StructureEntryInfo(-607680183, 8, StructureEntryDataType.Array, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, -1423573426),
                        new StructureEntryInfo(1538058350, 24, StructureEntryDataType.Array, 0, 2, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.Structure, 0, 0, -1189020045),
                        new StructureEntryInfo(-126806275, 40, StructureEntryDataType.Array, 0, 4, 0)
                    });

                case MetaName.CShaderVariableComponent:
                    return new StructureInfo(-413846757, -1209135571, 768, 0, 1342184480, 72, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-782713768, 8, StructureEntryDataType.UnsignedInt, 0, 0, 0),
                        new StructureEntryInfo(-1862731996, 12, StructureEntryDataType.UnsignedInt, 0, 0, 0),
                        new StructureEntryInfo(490746723, 16, StructureEntryDataType.Hash, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(794089857, 24, StructureEntryDataType.Array, 0, 3, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedShort, 0, 0, 0),
                        new StructureEntryInfo(-256046837, 40, StructureEntryDataType.Array, 0, 5, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-1200452924, 56, StructureEntryDataType.Array, 0, 7, 0)
                    });

                case MetaName.CPedPropExpressionData:
                    return new StructureInfo(-1423573426, 1355135810, 768, 0, 1342184128, 88, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(1389713939, 8, StructureEntryDataType.UnsignedInt, 0, 0, 0),
                        new StructureEntryInfo(461768873, 12, StructureEntryDataType.SignedInt, 0, 0, 0),
                        new StructureEntryInfo(-1025202508, 16, StructureEntryDataType.UnsignedInt, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(794089857, 24, StructureEntryDataType.Array, 0, 3, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedShort, 0, 0, 0),
                        new StructureEntryInfo(-256046837, 40, StructureEntryDataType.Array, 0, 5, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(138573281, 56, StructureEntryDataType.Array, 0, 7, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(-1200452924, 72, StructureEntryDataType.Array, 0, 9, 0)
                    });

                case MetaName.CPedCompExpressionData:
                    return new StructureInfo(-1189020045, -836802551, 768, 0, 1342184304, 88, 0, new ResourceSimpleArray<StructureEntryInfo>() {
                        new StructureEntryInfo(-957771174, 8, StructureEntryDataType.UnsignedInt, 0, 0, 0),
                        new StructureEntryInfo(-1404320405, 12, StructureEntryDataType.SignedInt, 0, 0, 0),
                        new StructureEntryInfo(656720598, 16, StructureEntryDataType.UnsignedInt, 0, 0, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedByte, 0, 0, 0),
                        new StructureEntryInfo(794089857, 24, StructureEntryDataType.Array, 0, 3, 0),
                        new StructureEntryInfo(256, 0, StructureEntryDataType.UnsignedShort, 0, 0, 0),
                        new StructureEntryInfo(-256046837, 40, StructureEntryDataType.Array, 0, 5, 0),
...
*/
        ...
        public static EnumInfo[] GetStructureEnumInfo(MetaName name)
        {
            ...
            switch (name)
            {
                ...
                case (MetaName)(94549140):
                    {
                        enumInfos.Add(MetaInfo.GetEnumInfo((MetaName)(-81990185)));
                        break;
                    }
                case MetaName.CAnchorProps:
                    {
                        enumInfos.Add(MetaInfo.GetEnumInfo((MetaName)(-1460418243)));
                        break;
                    }
                case (MetaName)(376833625):
                    {
                ...
                case MetaName.CComponentInfo:
                    {
                        enumInfos.Add(MetaInfo.GetEnumInfo((MetaName)(884254308)));
                        break;
                    }
                case (MetaName)(1036962405):
                    {
                ...
                case MetaName.CScenarioChainingEdge:
                    {
                        enumInfos.Add(MetaInfo.GetEnumInfo((MetaName)(-685159878)));
                        enumInfos.Add(MetaInfo.GetEnumInfo((MetaName)(-323193842)));
                        enumInfos.Add(MetaInfo.GetEnumInfo((MetaName)(941086046)));
                        break;
                    }
                case MetaName.CScenarioChain:
                    {
    ...
    public enum Unk_700327466 : int // Key : -1480371201
    {
        IgnoreMaxInRange = 0,
        NoSpawn = 1,
    ...
    public enum Unk_3573596290 : int // Key : 671739257
    {
        kBoth = 0,
        Unk_4171042740 = 1,
        Unk_549935372 = 2,
    ...
    public enum Unk_3609807418 : byte // Key : -968891497
    {
        Move = 0,
        Unk_7865678 = 1,
        MoveFollowMaster = 2,
    ...
    public enum Unk_3971773454 : byte // Key : -1278838554
    {
        Direct = 0,
        Unk_4272634460 = 1,
        Roads = 2,
    ...
    public enum Unk_941086046 : byte// Key : 1112851290
    {
        Unk_3279574318 = 0,
        Unk_2212923970 = 1,
        Unk_4022799658 = 2,
    ...
    public enum Unk_1991964615 : int // Key : 1866031916
    {
    ...
    public enum Unk_1264241711 : int // Key : 1856311430
    {
        LODTYPES_DEPTH_HD = 0,
    ...
    public enum Unk_648413703 : int // Key : -2094609585
    {
        PRI_REQUIRED = 0,
        PRI_OPTIONAL_HIGH = 1,
    ...
    public enum Unk_1294270217 : int // Key : -780397138
    {
    ...
    public enum Unk_2266515059 : int // Key : -7494951
    {
        Unk_665241531 = 0,
        Unk_462992848 = 1,
    }

    public enum Unk_884254308 : short // Key : -822882922
    {
        PV_COMP_INVALID = -1,
        PV_COMP_HEAD = 0,
        PV_COMP_BERD = 1,
    ...
    public enum Unk_4212977111 : int // Key : 1551913633
    {
        Unk_3757767268 = 0,
        Unk_3735238938 = 1,
        Unk_3395845123 = 2,
    ...
    public enum Unk_2834549053 : int // Key : 1309372691
    {
        ANCHOR_HEAD = 0,
        ANCHOR_EYES = 1,
        ANCHOR_EARS = 2,
    ...
    public enum Unk_3044470860: int // Key : 1585854303
    {
        Unk_997866013 = 0,
    }
    ...
    public struct CScenarioPointContainer // 48 bytes, Key:2489654897
    {
        public Array_Structure LoadSavePoints; // 0  Key: CExtensionDefSpawnPoint
        public Array_Structure MyPoints; // 16  Key: CScenarioPoint
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct Unk_4023740759 // 88 bytes, Key:88255871
    {
        public Array_Structure Nodes; // 0  Key: CScenarioChainingNode
        public Array_Structure Edges; // 16  Key: CScenarioChainingEdge
        public Array_Structure Chains; // 32  Key: CScenarioChain
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct rage__spdGrid2D // 64 bytes, Key:894636096
    {
        public uint Unused0; // 0
        public uint Unused1; // 4
        public uint Unused2; // 8
        public int Unk_860552138; // 12  Key: 0
        public int Unk_3824598937; // 16  Key: 0
        public int Unk_496029782; // 20  Key: 0
        public int Unk_3374647798; // 24  Key: 0
        public uint Unused3; // 28
        public uint Unused4; // 32
        public uint Unused5; // 36
        public uint Unused6; // 40
        public float Unk_2690909759; // 44  Key: 0
        public float Unk_3691675019; // 48  Key: 0
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CScenarioPointLookUps // 96 bytes, Key:2669361587
    {
        public Array_uint TypeNames; // 0  Key: 0
        public Array_uint PedModelSetNames; // 16  Key: 0
        public Array_uint VehicleModelSetNames; // 32  Key: 0
        public Array_uint GroupNames; // 48  Key: 0
        public Array_uint InteriorNames; // 64  Key: 0
        public Array_uint RequiredIMapNames; // 80  Key: 0
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CScenarioPointRegion // 376 bytes, Key:3501351821
    {
        public int VersionNumber; // 0  Key: 0
        public uint Unused0; // 4
        public CScenarioPointContainer Points; // 8  Key: CScenarioPointContainer
        public uint Unused1; // 56
        public uint Unused2; // 60
        public uint Unused3; // 64
        public uint Unused4; // 68
        public Array_Structure EntityOverrides; // 72  Key: CScenarioEntityOverride
        public uint Unused5; // 88
        public uint Unused6; // 92
        public Unk_4023740759 Unk_3696045377; // 96  Key: 4023740759
        public rage__spdGrid2D AccelGrid; // 184  Key: rage__spdGrid2D
        public Array_ushort Unk_3844724227; // 248  Key: 0
        public Array_Structure Clusters; // 264  Key: CScenarioPointCluster
        public CScenarioPointLookUps LookUps; // 280  Key: CScenarioPointLookUps
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CScenarioPoint // 64 bytes, Key:402442150
    {
        public byte Unused0; // 0
        public uint Unused1; // 1
        public uint Unused2; // 5
        public uint Unused3; // 9
        public uint Unused4; // 13
        public uint Unused5; // 17
        public byte iType; // 21  Key: 0
        public byte ModelSetId; // 22  Key: 0
        public byte iInterior; // 23  Key: 0
        public byte iRequiredIMapId; // 24  Key: 0
        public byte iProbability; // 25  Key: 0
        public byte uAvailableInMpSp; // 26  Key: 0
        public byte iTimeStartOverride; // 27  Key: 0
        public byte iTimeEndOverride; // 28  Key: 0
        public byte iRadius; // 29  Key: 0
        public byte iTimeTillPedLeaves; // 30  Key: 0
        public byte Unused6; // 31
        public ushort iScenarioGroup; // 32  Key: 0
        public short Unused7; // 34
        public Unk_700327466 Flags; // 36  Key: 700327466
        public uint Unused8; // 40
        public uint Unused9; // 44
        public Vector4 vPositionAndDirection; // 48  Key: 0
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CScenarioEntityOverride // 80 bytes, Key:1271200492
    {
        public Vector3 EntityPosition; // 0  Key: 0
        public uint Unused0; // 12
        public uint EntityType; // 16  Key: 0
        public uint Unused1; // 20
        public Array_Structure ScenarioPoints; // 24  Key: CExtensionDefSpawnPoint
        public uint Unused2; // 40
        public uint Unused3; // 44
        public uint Unused4; // 48
        public uint Unused5; // 52
        public uint Unused6; // 56
        public uint Unused7; // 60
        public byte Unk_538733109; // 64  Key: 0
        public byte Unk_1035513142; // 65  Key: 0
    }
    ...
    public struct CExtensionDefSpawnPoint // 96 bytes, Key:3077340721
    {
        ...
        public short Unused4; // 86
        public Unk_700327466 flags; // 88  Key: 700327466
        public byte highPri; // 92  Key: 0
        public byte extendedRange; // 93  Key: 0
        public byte shortRange; // 94  Key: 0
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CScenarioChainingNode // 32 bytes, Key:1811784424
    {
        public Vector3 Position; // 0  Key: 0
        public uint Unused0; // 12
        public uint Unk_2602393771; // 16  Key: 0
        public uint ScenarioType; // 20  Key: 0
        public byte Unk_407126079; // 24  Key: 0
        public byte Unk_1308720135; // 25  Key: 0
        public short Unused1; // 26
        public uint Unused2; // 28
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CScenarioChainingEdge // 8 bytes, Key:2004985940
    {
        public ushort NodeIndexFrom; // 0  Key: 0
        public ushort NodeIndexTo; // 2  Key: 0
        public Unk_3609807418 Action; // 4  Key: 3609807418
        public Unk_3971773454 NavMode; // 5  Key: 3971773454
        public Unk_941086046 NavSpeed; // 6  Key: 941086046
        public byte Unused0; // 7
        public uint Unused1; // 8
        public uint Unused2; // 12
        public uint Unused3; // 16
        public uint Unused4; // 20
        public uint Unused5; // 24
        public uint Unused6; // 28
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CScenarioChain // 40 bytes, Key:2751910366
    {
        public byte Unk_1156691834; // 0  Key: 0
        public byte Unused0; // 3
        public uint Unused1; // 4
        public Array_ushort EdgeIds; // 8  Key: 0
        public uint Unused2; // 24
        public uint Unused3; // 28
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct rage__spdSphere // 16 bytes, Key:1189037266
    {
        public Vector4 centerAndRadius; // 0  Key: 0
        public uint Unused0; // 16
        public uint Unused1; // 20
        public uint Unused2; // 24
        public uint Unused3; // 28
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct CScenarioPointCluster // 80 bytes, Key:3622480419
    {
        public CScenarioPointContainer Points; // 0  Key: CScenarioPointContainer
        public rage__spdSphere ClusterSphere; // 48  Key: rage__spdSphere
        public float Unk_1095875445; // 64  Key: 0
        public byte Unk_3129415068; // 68  Key: 0
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CStreamingRequestRecord // 40 bytes, Key:3825587854
    {
        public Array_Structure Frames; // 0  Key: CStreamingRequestFrame
        public Array_Structure CommonSets; // 16  Key: 1358189812
        public byte NewStyle; // 32  Key: 0
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CStreamingRequestFrame // 112 bytes, Key:1112444512
    {
        public Array_uint AddList; // 0  Key: 0
        public Array_uint RemoveList; // 16  Key: 0
        public Array_uint Unk_896120921; // 32  Key: 0
        public Vector3 CamPos; // 48  Key: 0
        public Vector3 CamDir; // 64  Key: 0
        public Array_byte Unk_1762439591; // 80  Key: 0
        public uint Flags; // 96  Key: 0
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct Unk_1358189812 // 16 bytes, Key:3710200606
    {
        public Array_uint Requests; // 0  Key: 0
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CStreamingRequestFrame_V2 // 96 bytes, Key:3672937465
    {
        public Array_uint AddList; // 0  Key: 0
        public Array_uint RemoveList; // 16  Key: 0
        public Vector3 CamPos; // 32  Key: 0
        public Vector3 CamDir; // 48  Key: 0
        public Array_byte Unk_1762439591; // 64  Key: 0
        public uint Flags; // 80  Key: 0
    }
    ...
    public struct CBaseArchetypeDef // 144 bytes, Key:2411387556
    {
        ...
        public uint Unused2; // 20
        public uint Unused3; // 24
        public uint Unused4; // 28
        public Vector3 bbMin; // 32  Key: 0
        public uint Unused5; // 44
        public Vector3 bbMax; // 48  Key: 0
        public uint Unused6; // 60
        ...
        public uint Unused8; // 116
        public Array_StructurePointer extensions; // 120  Key: 0
        public uint Unused9; //136
        public uint Unused10; //140
    }
    ...
    public struct CCreatureMetaData // 56 bytes, Key:2181653572
    {
        public uint Unused0; // 0
        public uint Unused1; // 4
        public Array_Structure shaderVariableComponents; // 8  Key: CShaderVariableComponent
        public Array_Structure pedPropExpressions; // 24  Key: CPedPropExpressionData
        public Array_Structure pedCompExpressions; // 40  Key: CPedCompExpressionData
    }
    ...
    public struct CShaderVariableComponent // 72 bytes, Key:3085831725
    {
        public uint Unused0; // 0
        public uint Unused1; // 4
        public uint pedcompID; // 8  Key: 0
        public uint maskID; // 12  Key: 0
        public uint shaderVariableHashString; // 16  Key: 0
        public byte Unused2; // 21
        public short Unused3; // 22
        public Array_byte tracks; // 24  Key: 0
        public Array_ushort ids; // 40  Key: 0
        public Array_byte components; // 56  Key: 0
    }
    ...
    public struct CPedPropExpressionData // 88 bytes, Key:1355135810
    {
        public uint Unused0; // 0
        public uint Unused1; // 4
        public uint pedPropID; // 8  Key: 0
        public int pedPropVarIndex; // 12  Key: 0
        public uint pedPropExpressionIndex; // 16  Key: 0
        public byte Unused2; // 21
        public short Unused3; // 22
        public Array_byte tracks; // 24  Key: 0
        public Array_ushort ids; // 40  Key: 0
        public Array_byte types; // 56  Key: 0
        public Array_byte components; // 72  Key: 0
    }
    ...
    public struct CPedCompExpressionData // 88 bytes, Key:3458164745
    {
        ...
        public uint Unused1; // 4
        public uint pedCompID; // 8  Key: 0
        public int pedCompVarIndex; // 12  Key: 0
        public uint pedCompExpressionIndex; // 16  Key: 0
        public byte Unused2; // 21
        public short Unused3; // 22
        public Array_byte tracks; // 24  Key: 0
        public Array_ushort ids; // 40  Key: 0
    ...
    public struct CTimeArchetypeDef // 160 bytes, Key:2520619910
    {
        ...
        public uint Unused11; // 148
        public uint Unused12; // 152
        public uint Unused13; // 156
    }
    ...
    public struct CLightAttrDef // 160 bytes, Key:2363260268
    {
        ...
        public Vector4 cullingPlane; // 48  Key: 4
        ...
        public Vector3 direction; // 112  Key: 3
        public Vector3 tangent; // 124  Key: 3
        public float coneInnerAngle; // 136  Key: 0
        public float coneOuterAngle; // 140  Key: 0
        public Vector3 extents; // 144  Key: 3
    ...
    public struct CMloArchetypeDef // 240 bytes, Key:937664754
    {
        ...
        public uint Unused12; //232
        public uint Unused13; //236
    }
    ...
    public struct CMloRoomDef // 112 bytes, Key:3885428245
    {
        ...
        public uint Unused6; //92
        public Array_uint attachedObjects; // 96  Key: 0
    }
    ...
    public struct CMloPortalDef // 64 bytes, Key:1110221513
    {
        ...
        public Array_uint attachedObjects; // 48  Key: 0
    }
    ...
    public struct CExtensionDefLadder // 96 bytes, Key:1978210597
    {
        ...
        public byte canGetOffAtTop; // 88  Key: 0
        public byte canGetOffAtBottom; // 89  Key: 0
    }
    ...
    public struct CExtensionDefExpression // 48 bytes, Key:24441706
    {
        ...
        public byte Unk_1562817888; // 44  Key: 0
    }
    ...
    public struct CExtensionDefLightShaft // 176 bytes, Key:2526429398
    {
        ...
        public byte Unused9; // 153
        public short Unused10; // 154
        ...
        public byte Unk_59101696; // 172  Key: 0
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct Unk_2858946626 // 40 bytes, Key:1792487819
    {
        public byte Unk_2598445407; // 0  Key: 0
        public byte Unused0; // 1
        public short Unused1; // 2
        public uint Unused2; // 4
        public Array_Structure Unk_3902803273; // 8  Key: 94549140
        public Array_Structure aAnchors; // 24  Key: CAnchorProps

    }


    [StructLayout(LayoutKind.Sequential)]
    public struct Unk_376833625 // 112 bytes, Key:4030871161
    {
        public byte Unk_1235281004; // 0  Key: 0
        public byte Unk_4086467184; // 1  Key: 0
        public byte Unk_911147899; // 2  Key: 0
        public byte Unk_315291935; // 3  Key: 0
        public ArrayOfBytes12 Unk_2996560424; // 4  Key: PsoPOINTER
        public Array_Structure Unk_3796409423; // 16  Key: 3538495220
        public Array_Structure Unk_2131007641; // 32  Key: 253191135
        public Array_Structure compInfos; // 48  Key: CComponentInfo
        public Unk_2858946626 propInfo; // 64  Key: 2858946626
        public uint dlcName; // 104  Key: 0
        public int Unused0; // 108
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct Unk_3538495220 // 24 bytes, Key:2024084511
    {
        public byte Unk_3371516811; // 0  Key: 0
        public byte Unused0; // 1
        public short Unused1; // 2
        public uint Unused2; // 4
        public Array_Structure Unk_1756136273; // 8  Key: 1535046754
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct Unk_2236980467 // 24 bytes, Key:508935687
    {
        public byte Unk_2828247905; // 0  Key: 0
        public byte Unused0; // 1
        public short Unused1; // 2
        public uint Unused2; // 4
        public uint Unused3; // 8
        public uint Unused4; // 12
        public uint Unused5; // 16
        public uint Unused6; // 20
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct Unk_1535046754 // 48 bytes, Key:124073662
    {
        public byte propMask; // 0  Key: 0
        public byte Unk_2806194106; // 1  Key: 0
        public short Unused0; // 2
        public uint Unused1; // 4
        public Array_Structure aTexData; // 8  Key: 1036962405
        public Unk_2236980467 clothData; // 24  Key: 2236980467
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct Unk_1036962405 // 3 bytes, Key:4272717794
    {
        public byte texId; // 0  Key: 0
        public byte distribution; // 1  Key: 0
        public byte Unused0; // 2
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CComponentInfo // 48 bytes, Key:3693847250
    {
        public uint Unk_802196719; // 0  Key: 0
        public uint Unk_4233133352; // 4  Key: 0
        public ArrayOfBytes5 Unk_128864925; // 8  Key: 5
        public byte Unused0; //13
        public ushort Unused1; //14
        public uint Unused2; //16
        public uint Unused3; //20
        public uint Unused4; //24
        public uint flags; // 28  Key: 0
        public int inclusions; // 32  Key: 0
        public int exclusions; // 36  Key: 0
        public short Unk_1613922652; // 40  Key: 884254308
        public ushort Unk_2114993291; // 42  Key: 0
        public byte Unk_3509540765; // 44  Key: 0
        public byte Unk_4196345791; // 45  Key: 0
        public short Unused5; //46
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct Unk_94549140 // 56 bytes, Key:2029738350
    {
        public uint audioId; // 0  Key: 0
        public ArrayOfBytes5 expressionMods; // 4  Key: 5
        public byte Unused0; //9
        public ushort Unused1; //10
        public uint Unused2; //12
        public uint Unused3; //16
        public uint Unused4; //20
        public Array_Structure texData; // 24  Key: 254518642
        public Unk_4212977111 renderFlags; // 40  Key: 4212977111
        public uint propFlags; // 44  Key: 0
        public ushort flags; // 48  Key: 0
        public byte anchorId; // 50  Key: 0
        public byte propId; // 51  Key: 0
        public byte Unk_2894625425; // 52  Key: 0
        public byte Unused5; //53
        public ushort Unused6; //54
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct Unk_254518642 // 12 bytes, Key:2767296137
    {
        public int inclusions; // 0  Key: 0
        public int exclusions; // 4  Key: 0
        public byte texId; // 8  Key: 0
        public byte inclusionId; // 9  Key: 0
        public byte exclusionId; // 10  Key: 0
        public byte distribution; // 11  Key: 0
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CAnchorProps // 24 bytes, Key:403574180
    {
        public Array_byte props; // 0  Key: 0
        public Unk_2834549053 anchor; // 16  Key: 2834549053
        public uint Unused0; //20
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct Unk_253191135 // 48 bytes, Key:3120284999
    {
        public uint name; // 0  Key: 0
        public ArrayOfBytes12 Unk_173599222; // 4  Key: PsoPOINTER
        public ArrayOfBytes12 Unk_2991454271; // 16  Key: PsoPOINTER
        public ArrayOfBytes6 Unk_3598106198; // 28  Key: 6
        public ArrayOfBytes6 Unk_2095974912; // 34  Key: 6
        public ArrayOfBytes6 Unk_672172037; // 40  Key: 6
        public short Unused0; // 46
    }


    [StructLayout(LayoutKind.Sequential)]
    public struct CBaseArchetypeDef_V2 // 128 bytes, Key:2352343492
    {
        public uint Unused0; // 0
        public uint Unused1; // 4
        public float lodDist; // 8  Key: 0
    ...
    public struct CExtensionDefDoor // 48 bytes, Key:2671601385
    {
        ...
        public Vector3 offsetPosition; // 16  Key: 0
        public uint Unused3; // 28
        public byte enableLimitAngle; // 32  Key: 0
        public byte startsLocked; // 33  Key: 0
        public byte canBreak; // 34  Key: 0
        public byte Unused4; // 35
    ...
    public struct rage__spdAABB // 32 bytes, Key:1158138379
    {
        ...
        public void SwapEnd()
        {
            min = MetaUtils.SwapBytes(min);
            max = MetaUtils.SwapBytes(max);
        }
    }
