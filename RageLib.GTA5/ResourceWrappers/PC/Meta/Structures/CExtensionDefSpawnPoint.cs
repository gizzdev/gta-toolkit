...
{
	public class CExtensionDefSpawnPoint : MetaStructureWrapper<RageLib.Resources.GTA5.PC.Meta.CExtensionDefSpawnPoint>
	{
		...
		public CExtensionDefSpawnPoint()
		{
			this.MetaName = MetaName.CExtensionDefSpawnPoint;
			this.MetaStructure = new RageLib.Resources.GTA5.PC.Meta.CExtensionDefSpawnPoint();
		}

		public override void Parse(MetaFile meta, RageLib.Resources.GTA5.PC.Meta.CExtensionDefSpawnPoint CExtensionDefSpawnPoint)
		{
			this.Meta = meta;
