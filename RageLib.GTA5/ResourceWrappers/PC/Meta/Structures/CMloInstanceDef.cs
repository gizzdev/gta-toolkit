...
{
	public class CMloInstanceDef : MetaStructureWrapper<RageLib.Resources.GTA5.PC.Meta.CMloInstanceDef>
	{
		...
		public CMloInstanceDef()
		{
			this.MetaName = MetaName.CMloInstanceDef;
			this.MetaStructure = new RageLib.Resources.GTA5.PC.Meta.CMloInstanceDef();
		}

		public override void Parse(MetaFile meta, RageLib.Resources.GTA5.PC.Meta.CMloInstanceDef CMloInstanceDef)
		{
			this.Meta = meta;
