...
{
	public class CExtensionDefSpawnPointOverride : MetaStructureWrapper<RageLib.Resources.GTA5.PC.Meta.CExtensionDefSpawnPointOverride>
	{
		...
		public CExtensionDefSpawnPointOverride()
		{
			this.MetaName = MetaName.CExtensionDefSpawnPointOverride;
			this.MetaStructure = new RageLib.Resources.GTA5.PC.Meta.CExtensionDefSpawnPointOverride();
		}

		public override void Parse(MetaFile meta, RageLib.Resources.GTA5.PC.Meta.CExtensionDefSpawnPointOverride CExtensionDefSpawnPointOverride)
		{
			this.Meta = meta;
