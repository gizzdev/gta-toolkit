...
{
	public class CTimeArchetypeDef : MetaStructureWrapper<RageLib.Resources.GTA5.PC.Meta.CTimeArchetypeDef>
	{
		...
		public CTimeArchetypeDef()
		{
			this.MetaName = MetaName.CTimeArchetypeDef;
			this.MetaStructure = new RageLib.Resources.GTA5.PC.Meta.CTimeArchetypeDef();
		}

		public override void Parse(MetaFile meta, RageLib.Resources.GTA5.PC.Meta.CTimeArchetypeDef CTimeArchetypeDef)
		{
			this.Meta = meta;
