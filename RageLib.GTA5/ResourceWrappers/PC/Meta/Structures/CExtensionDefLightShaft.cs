...
{
	public class CExtensionDefLightShaft : MetaStructureWrapper<RageLib.Resources.GTA5.PC.Meta.CExtensionDefLightShaft>
	{
		...
		public CExtensionDefLightShaft()
		{
			this.MetaName = MetaName.CExtensionDefLightShaft;
			this.MetaStructure = new RageLib.Resources.GTA5.PC.Meta.CExtensionDefLightShaft();
		}

		public override void Parse(MetaFile meta, RageLib.Resources.GTA5.PC.Meta.CExtensionDefLightShaft CExtensionDefLightShaft)
		{
			this.Meta = meta;
