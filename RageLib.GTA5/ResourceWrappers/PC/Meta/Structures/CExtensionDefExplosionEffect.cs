...
{
	public class CExtensionDefExplosionEffect : MetaStructureWrapper<RageLib.Resources.GTA5.PC.Meta.CExtensionDefExplosionEffect>
	{
		...
		public CExtensionDefExplosionEffect()
		{
			this.MetaName = MetaName.CExtensionDefExplosionEffect;
			this.MetaStructure = new RageLib.Resources.GTA5.PC.Meta.CExtensionDefExplosionEffect();
		}

		public override void Parse(MetaFile meta, RageLib.Resources.GTA5.PC.Meta.CExtensionDefExplosionEffect CExtensionDefExplosionEffect)
		{
			this.Meta = meta;
